    ...
    <main id="main">
      <section id="starters">
        ...
        <ul>
          ...
          <li>
            <img
              src="https://www.mypricechopper.com/Frontend/Media/Recipes/BakedChickenWings_Web_1110x625.jpg"
              width="300"
            />
            <p>Wings</p>
            <AddToOrderButton />
          ...
          <li>
            <img
              src="https://static01.nyt.com/images/2018/12/11/dining/as-garlic-bread/as-garlic-bread-superJumbo.jpg"
              width="300"
            />
            <p>Garlic Bread</p>
            <AddToOrderButton />
      ...
      <section id="pizzas">
        ...
        <ul>
          ...
          <li>
            <img
              src="https://www.jennycancook.com/wp-content/uploads/2013/02/PeppPizza_600.jpg"
              width="300"
            />
            <p>Pepperoni</p>
            <AddToOrderButton />
